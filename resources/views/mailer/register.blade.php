...
<head>
	...
	<title>Bienvenido | Siseepv</title>
												...
												<table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
													<tr>
														<td style="text-align:left; color: #6f6f6f;">
															...
															Tu cuenta ha sido creada exitosamente, a continuación te presentamos tus credenciales de acceso, para cualquier duda o aclaración no dudes en <a href="#">contactar a soporte tecnico</a>. <br><br>
															Usuario:{{ $datamail['email'] }} <br>
															Contraseña: {{ $datamail['pass'] }}<br><br>
